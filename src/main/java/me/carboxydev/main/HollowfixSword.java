...
public class HollowfixSword extends SwordItem {
    ...
    public HollowfixSword(ToolMaterial instance, int attackDamage, float attackSpeed, Settings settings) {
    ...
    public void appendTooltip(ItemStack itemStack, World world, java.util.List<net.minecraft.text.Text> tooltip, net.minecraft.client.item.TooltipContext tooltipContext) {
        tooltip.add(Text.translatable("item.carboxydev_demo_mod.hollowfix_sword.tooltip").formatted(Formatting.GOLD));
    }
